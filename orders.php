...
$query = " insert into orders (user, email, mobile, address, city, state, zipcode, choose, size, cupcake)
values ('$user', '$email', '$mobile', '$address', '$city', '$state', '$zipcode', '$choose', '$size', '$cupcake') ";
 ...
 <body>
 	...
 	<div class="some-another some-another-page text-center py-5">
 		<div class="container py-xl-5 py-lg-3">
 			<h1 class="text-uppsecase font-weight-bold text-dark mt-4">Thanks for ordering from CakesBakery !</h1>
      <br>
 			<h4 class="aboutright about-right-2">Your order will reach you soon till then sit back and relex. Fresh and healthy cakes at your doorstep.</h4>
      <br>
      <br>
